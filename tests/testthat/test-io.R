...
test_that("get_report_date_range", {
  ...
  expect_error(get_report_date_range(params),
...
test_that("get_training_date_range", {
  ...
  expect_equal(
    ...
    list("training_start_date"=Sys.Date() - 28, "training_end_date"=Sys.Date())
  )
  ...
  empty_obj <- list()
  saveRDS(empty_obj,
          file=file.path(tdir, "20201031_changehc_covid_state_lambda0.1_gamma0.1_fraction_ny_lag1_tau0.5.rds"))
  saveRDS(empty_obj,
          file=file.path(tdir, "20201031_changehc_covid_state_lambda0.1_gamma0.1_fraction_ny_lag1_tau0.75.rds"))
  expect_equal(
    get_training_date_range(params),
  ...
  saveRDS(empty_obj,
          file=file.path(tdir, "20211031_changehc_covid_state_lambda0.1_gamma0.1_fraction_ny_lag1_tau0.5.rds"))
  expect_equal(
    get_training_date_range(params),
  ...
  saveRDS(empty_obj,
          file=file.path(tdir, "20221031_flu_covid_state_lambda0.1_fraction_ny_lag1_tau0.5.rds"))
  expect_equal(
    get_training_date_range(params),
    list("training_start_date"=as.Date("2022-10-03"), "training_end_date"=as.Date("2022-10-31"))
  )
  file.remove(file.path(tdir, "20201031_changehc_covid_state_lambda0.1_gamma0.1_fraction_ny_lag1_tau0.5.rds"))
  file.remove(file.path(tdir, "20201031_changehc_covid_state_lambda0.1_gamma0.1_fraction_ny_lag1_tau0.75.rds"))
